            ...
            <div className="notification-container">
                ...
                <div className="dropdown-menu" ref={(ref) => {
                    ...
                    <div className="notification-header">
                        <span>{I18n.t('application.notifications.name')}</span>
                        <a className="pull-right mark-all-as-read"
                           onClick={(e) => this.handleMarkAllAsRead(e)}>
                            {I18n.t('application.notifications.mark_all_as_read')}
                        </a>
                    </div>
                    <ul
                        onScroll={() => this.handleScroll()}
                        ref={(ref) => {
                            this.notificationsListRef = ref
                        }}
